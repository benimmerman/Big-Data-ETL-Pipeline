...
for object in s3_client.list_objects_v2(Bucket='<s3 path to up to date csv files>')['Contents']:
...
if s3_file_list==required_file_list:
    s3_file_url = ['<s3 path to up to date csv files>' + a for a in s3_file_list]
